...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="relative w-full h-[460px] rounded-[40px] overflow-hidden bg-primary">
        <Image
        ...
        <div className="absolute inset-0 flex flex-col gap-4 text-white justify-center items-center">
          <div className="transform translate-x-8/1 translate-y-2/1">
            <Image
          ...
          <button className="font-bold bg-orange px-6 rounded-[10px] text-xl py-2 mt-2 border-1 border-orange hover:text-orange hover:bg-transparent transition-all duration-300 cursor-pointer">
            {t.hero.cta}
          </button>
